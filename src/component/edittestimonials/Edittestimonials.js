...
function Edittestimonials () {
    ...
    const handleButton = () => {
        ...
        axios.post(`http://localhost:8080/api/update-testiomonals`,
            formData 
        )
            .then(res => {
                console.log(res);
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-6">
                            <div className="section-title text-center pb-10">
                                <h4 className="title">Edit Testimonial</h4>
                            </div> 
                        </div>
                    </div> 
                    <div className="row justify-content-center">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-12">
                                            <div className="single-form form-group text-center">
                                                <button type="submit" className="main-btn" onClick={handleButton}>Update Testimonial</button>
                                            </div> 
                                        </div>
                                    </div> 
